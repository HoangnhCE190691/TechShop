...
<div class="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden">
        <div class="bg-gradient-to-r from-teal-600 to-emerald-700 px-6 py-8 text-white">
            <h1 class="text-2xl font-bold">Edit employee information</h1>
            <p class="text-teal-100 mt-2">Update your personal profile on the administration system.</p>
        </div>

        <form action="profilestaff" method="POST" class="p-8 space-y-6">
            ...
            <div class="pt-6 border-t border-gray-200 flex items-center justify-end gap-4">
                <a href="profilestaff" class="px-6 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                 Cancel
                </a>
