...
<div class="max-w-md mx-auto py-12 px-4">
    <div class="bg-white shadow-2xl rounded-2xl overflow-hidden border border-gray-100">
        ...
        <form action="profileemployee" method="POST" class="p-8 space-y-5" id="changePasswordForm">
            ...
            <div>
                ...
                <div id="checklist" class="mt-3 space-y-1">
                    <p id="length" class="text-xs text-red-500 transition-all duration-200">✖ At least 8 characters</p>
                    <p id="uppercase" class="text-xs text-red-500 transition-all duration-200">✖ At least 1 uppercase letter (A-Z)</p>
                    <p id="special" class="text-xs text-red-500 transition-all duration-200">✖ At least 1 special character (!@#$...)</p>
                </div>
            </div>
            ...
            <div class="pt-4">
                ...
                <a href="profileemployee" class="block text-center mt-4 text-sm text-gray-500 hover:text-gray-700">
                    Return to Dashboard
                </a>
            </div>
        </form>
