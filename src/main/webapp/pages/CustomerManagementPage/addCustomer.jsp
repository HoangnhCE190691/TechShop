            ...
            <div class="grid md:grid-cols-2 md:gap-8">
                <div class="relative z-0 w-full group">
                    <input type="text" name="username" id="username" 
                           value="${oldUsername}"
                           pattern="^[a-zA-Z0-9]+$"
                           title="Username chỉ được chứa chữ cái và số, không bao gồm khoảng trắng hay ký tự đặc biệt."
                ...
                <div class="relative z-0 w-full group">
                    <input type="text" name="full_name" id="full_name" 
                           ...
                           title="Họ tên chỉ được chứa chữ cái và khoảng trắng, không bao gồm số hay ký tự đặc biệt."
